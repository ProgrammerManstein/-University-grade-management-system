            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="#" class="logo row">
                        ...
                        <h2 class="text-black-50">新建教师</h2>
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
...
<div class="container">
    <div class="row">
        <div class="col-12">
            <form class="form-horizontal form-inline col-12" id="tform" action="insertTeacherActionServlet" method="post">
                <div class="form-group col-12 " >
                    <label class="col-3  control-label" title="头衔" style="justify-content: left">头衔</label>
                    <input type="text" class="col-8" name="Ttitle">
                </div>
                <div class="form-group col-12 " >
                    <label class="col-3  control-label" title="电话" style="justify-content: left">电话</label>
                    <input type="text" class="col-8" name="Tphone">
                </div>
