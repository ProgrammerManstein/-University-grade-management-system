...
<div class="container">
    <div class="row">
        <div class="col-12">
            <form class="form-horizontal form-inline col-12" id="tform" action="admin_score.jsp" method="post">
                <div class="form-group col-12 " >
                    <label class="col-3  control-label" title="学号" style="justify-content: left">学生编号</label>
    ...
    <div class="container">
        ...
        <div class="row col-12">
            ...
            <%
                ...
                if(num==0){
                    lists1=dao1.findByNo(Sno);
                }
                else {
                    lists1 = dao1.findByTerm(num, Sno);
                }
            %>
